---
id: oauth_clients-model-create-o-auth-client-response
title: CreateOAuthClientResponse
pagination_label: CreateOAuthClientResponse
sidebar_label: CreateOAuthClientResponse
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'CreateOAuthClientResponse', 'oauth_clients']
slug: /tools/sdk/angular/oauth_clients/models/create-o-auth-client-response
tags: ['SDK', 'Software Development Kit', 'CreateOAuthClientResponse', 'oauth_clients']
---
...
```typescript
import { CreateOAuthClientResponse } from '@sailpoint/angular-sdk/oauth_clients';
```
