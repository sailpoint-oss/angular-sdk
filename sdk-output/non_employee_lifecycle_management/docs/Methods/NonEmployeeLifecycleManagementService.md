---
id: non_employee_lifecycle_management-method-non-employee-lifecycle-management
...
keywords: ['angular', 'Angular', 'sdk', 'NonEmployeeLifecycleManagement', 'non_employee_lifecycle_management']
slug: /tools/sdk/angular/non_employee_lifecycle_management/methods/non-employee-lifecycle-management
tags: ['SDK', 'Software Development Kit', 'NonEmployeeLifecycleManagement', 'non_employee_lifecycle_management']
---

# NonEmployeeLifecycleManagementService
...
[**get-non-employee-approval-summary-v1**](#get-non-employee-approval-summary-v1) | **GET** `/non-employee-approvals/v1/summary/{requestedFor}` | Get summary of non-employee approval requests
...
[**get-non-employee-request-summary-v1**](#get-non-employee-request-summary-v1) | **GET** `/non-employee-requests/v1/summary/{requestedFor}` | Get summary of non-employee requests
...
The service takes one object that holds every parameter. Its type is `ApproveNonEmployeeRequestV1RequestParams`.
...
`Observable<NonEmployeeApprovalItem>`
...
export class ExampleComponent {
  ...
  approveNonEmployeeRequestV1(): void {
    const id: string = ; // Non-Employee approval item id (UUID)
    const nonEmployeeApprovalDecision: NonEmployeeApprovalDecision = ; // 
    this.api.approveNonEmployeeRequestV1({ id: id, nonEmployeeApprovalDecision: nonEmployeeApprovalDecision }).subscribe({
...
The service takes one object that holds every parameter. Its type is `CreateNonEmployeeRecordV1RequestParams`.
...
export class ExampleComponent {
  ...
  createNonEmployeeRecordV1(): void {
    const nonEmployeeRequestBody: NonEmployeeRequestBody = ; // Non-Employee record creation request body.
    this.api.createNonEmployeeRecordV1({ nonEmployeeRequestBody: nonEmployeeRequestBody }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `CreateNonEmployeeRequestV1RequestParams`.
...
export class ExampleComponent {
  ...
  createNonEmployeeRequestV1(): void {
    const nonEmployeeRequestBody: NonEmployeeRequestBody = ; // Non-Employee creation request body
    this.api.createNonEmployeeRequestV1({ nonEmployeeRequestBody: nonEmployeeRequestBody }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `CreateNonEmployeeSourceSchemaAttributesV1RequestParams`.
...
`Observable<NonEmployeeSchemaAttribute>`
...
export class ExampleComponent {
  ...
  createNonEmployeeSourceSchemaAttributesV1(): void {
    const sourceId: string = ; // The Source id
    const nonEmployeeSchemaAttributeBody: NonEmployeeSchemaAttributeBody = ; // 
    this.api.createNonEmployeeSourceSchemaAttributesV1({ sourceId: sourceId, nonEmployeeSchemaAttributeBody: nonEmployeeSchemaAttributeBody }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `CreateNonEmployeeSourceV1RequestParams`.
...
`Observable<NonEmployeeSourceWithCloudExternalId>`
...
export class ExampleComponent {
  ...
  createNonEmployeeSourceV1(): void {
    const nonEmployeeSourceRequestBody: NonEmployeeSourceRequestBody = ; // Non-Employee source creation request body.
    this.api.createNonEmployeeSourceV1({ nonEmployeeSourceRequestBody: nonEmployeeSourceRequestBody }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeRecordV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeRecordV1(): void {
    const id: string = ; // Non-Employee record id (UUID)
    this.api.deleteNonEmployeeRecordV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeRecordsInBulkV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeRecordsInBulkV1(): void {
    ...
    this.api.deleteNonEmployeeRecordsInBulkV1({ deleteNonEmployeeRecordsInBulkV1Request: deleteNonEmployeeRecordsInBulkV1Request }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeRequestV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeRequestV1(): void {
    const id: string = ; // Non-Employee request id in the UUID format
    this.api.deleteNonEmployeeRequestV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeSchemaAttributeV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeSchemaAttributeV1(): void {
    const attributeId: string = ; // The Schema Attribute Id (UUID)
    const sourceId: string = ; // The Source id
    this.api.deleteNonEmployeeSchemaAttributeV1({ attributeId: attributeId, sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeSourceSchemaAttributesV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeSourceSchemaAttributesV1(): void {
    const sourceId: string = ; // The Source id
    this.api.deleteNonEmployeeSourceSchemaAttributesV1({ sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `DeleteNonEmployeeSourceV1RequestParams`.
...
export class ExampleComponent {
  ...
  deleteNonEmployeeSourceV1(): void {
    const sourceId: string = ; // Source Id
    this.api.deleteNonEmployeeSourceV1({ sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ExportNonEmployeeRecordsV1RequestParams`.
...
export class ExampleComponent {
  ...
  exportNonEmployeeRecordsV1(): void {
    const id: string = ; // Source Id (UUID)
    this.api.exportNonEmployeeRecordsV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ExportNonEmployeeSourceSchemaTemplateV1RequestParams`.
...
export class ExampleComponent {
  ...
  exportNonEmployeeSourceSchemaTemplateV1(): void {
    const id: string = ; // Source Id (UUID)
    this.api.exportNonEmployeeSourceSchemaTemplateV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeApprovalSummaryV1RequestParams`.
...
`Observable<NonEmployeeApprovalSummary>`
...
export class ExampleComponent {
  ...
  getNonEmployeeApprovalSummaryV1(): void {
    const requestedFor: string = ; // The identity (UUID) of the approver for whom for whom the summary is being retrieved. Use \&quot;me\&quot; instead to indicate the current user.
    this.api.getNonEmployeeApprovalSummaryV1({ requestedFor: requestedFor }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeApprovalV1RequestParams`.
...
`Observable<NonEmployeeApprovalItemDetail>`
...
export class ExampleComponent {
  ...
  getNonEmployeeApprovalV1(): void {
    const id: string = ; // Non-Employee approval item id (UUID)
    const includeDetail: boolean = ; // The object nonEmployeeRequest will not be included detail when set to false. *Default value is true* (optional)
    this.api.getNonEmployeeApprovalV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeBulkUploadStatusV1RequestParams`.
...
`Observable<NonEmployeeBulkUploadStatus>`
...
export class ExampleComponent {
  ...
  getNonEmployeeBulkUploadStatusV1(): void {
    const id: string = ; // Source ID (UUID)
    this.api.getNonEmployeeBulkUploadStatusV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeRecordV1RequestParams`.
...
export class ExampleComponent {
  ...
  getNonEmployeeRecordV1(): void {
    const id: string = ; // Non-Employee record id (UUID)
    this.api.getNonEmployeeRecordV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeRequestSummaryV1RequestParams`.
...
`Observable<NonEmployeeRequestSummary>`
...
export class ExampleComponent {
  ...
  getNonEmployeeRequestSummaryV1(): void {
    const requestedFor: string = ; // The identity (UUID) of the non-employee account manager for whom the summary is being retrieved. Use \&quot;me\&quot; instead to indicate the current user.
    this.api.getNonEmployeeRequestSummaryV1({ requestedFor: requestedFor }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeRequestV1RequestParams`.
...
export class ExampleComponent {
  ...
  getNonEmployeeRequestV1(): void {
    const id: string = ; // Non-Employee request id (UUID)
    this.api.getNonEmployeeRequestV1({ id: id }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeSchemaAttributeV1RequestParams`.
...
export class ExampleComponent {
  ...
  getNonEmployeeSchemaAttributeV1(): void {
    const attributeId: string = ; // The Schema Attribute Id (UUID)
    const sourceId: string = ; // The Source id
    this.api.getNonEmployeeSchemaAttributeV1({ attributeId: attributeId, sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeSourceSchemaAttributesV1RequestParams`.
...
`Observable<Array<NonEmployeeSchemaAttribute>>`
...
export class ExampleComponent {
  ...
  getNonEmployeeSourceSchemaAttributesV1(): void {
    const sourceId: string = ; // The Source id
    this.api.getNonEmployeeSourceSchemaAttributesV1({ sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `GetNonEmployeeSourceV1RequestParams`.
...
export class ExampleComponent {
  ...
  getNonEmployeeSourceV1(): void {
    const sourceId: string = ; // Source Id
    this.api.getNonEmployeeSourceV1({ sourceId: sourceId }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ImportNonEmployeeRecordsInBulkV1RequestParams`.


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**id** | `string` | Source Id (UUID) |  [default to undefined]
**data** | `Blob` |  |  [default to undefined]

### Return type

`Observable<NonEmployeeBulkUploadJob>`
...
export class ExampleComponent {
  ...
  importNonEmployeeRecordsInBulkV1(): void {
    const id: string = ; // Source Id (UUID)
    const data: Blob = ; // 
    this.api.importNonEmployeeRecordsInBulkV1({ id: id, data: data }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ListNonEmployeeApprovalsV1RequestParams`.
...
`Observable<Array<NonEmployeeApprovalItem>>`
...
export class ExampleComponent {
  ...
  listNonEmployeeApprovalsV1(): void {
    const requestedFor: string = ; // The identity for whom the request was made. *me* indicates the current user. (optional)
    ...
    const filters: string = ; // Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **approvalStatus**: *eq* (optional)
    ...
    this.api.listNonEmployeeApprovalsV1({  }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ListNonEmployeeRecordsV1RequestParams`.
...
`Observable<Array<NonEmployeeRecord>>`
...
export class ExampleComponent {
  ...
  listNonEmployeeRecordsV1(): void {
    const limit: number = ; // Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const offset: number = ; // Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const count: boolean = ; // If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const sorters: string = ; // Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, accountName, sourceId, manager, firstName, lastName, email, phone, startDate, endDate, created, modified** (optional)
    const filters: string = ; // Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **sourceId**: *eq* (optional)
    this.api.listNonEmployeeRecordsV1({  }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ListNonEmployeeRequestsV1RequestParams`.
...
`Observable<Array<NonEmployeeRequest>>`
...
export class ExampleComponent {
  ...
  listNonEmployeeRequestsV1(): void {
    const requestedFor: string = ; // The identity for whom the request was made. *me* indicates the current user.
    const limit: number = ; // Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const offset: number = ; // Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const count: boolean = ; // If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const sorters: string = ; // Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **created, approvalStatus, firstName, lastName, email, phone, accountName, startDate, endDate** (optional)
    const filters: string = ; // Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **sourceId**: *eq*  (optional)
    this.api.listNonEmployeeRequestsV1({ requestedFor: requestedFor }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `ListNonEmployeeSourcesV1RequestParams`.
...
`Observable<Array<NonEmployeeSourceWithNECount>>`
...
export class ExampleComponent {
  ...
  listNonEmployeeSourcesV1(): void {
    const limit: number = ; // Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const offset: number = ; // Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const count: boolean = ; // If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count&#x3D;true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information. (optional)
    const requestedFor: string = ; // Identity the request was made for. Use \&#39;me\&#39; to indicate the current user. (optional)
    const nonEmployeeCount: boolean = ; // Flag that determines whether the API will return a non-employee count associated with the source. (optional)
    const sorters: string = ; // Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, created, sourceId** (optional)
    this.api.listNonEmployeeSourcesV1({  }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `PatchNonEmployeeRecordV1RequestParams`.
...
export class ExampleComponent {
  ...
  patchNonEmployeeRecordV1(): void {
    const id: string = ; // Non-employee record id (UUID)
    const jsonPatchOperation: Array<JsonPatchOperation> = ; // A list of non-employee update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard. Attributes are restricted by user type. Owner of source can update end date. Organization admins can update all available fields.
    this.api.patchNonEmployeeRecordV1({ id: id, jsonPatchOperation: jsonPatchOperation }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `PatchNonEmployeeSchemaAttributeV1RequestParams`.
...
export class ExampleComponent {
  ...
  patchNonEmployeeSchemaAttributeV1(): void {
    const attributeId: string = ; // The Schema Attribute Id (UUID)
    const sourceId: string = ; // The Source id
    const jsonPatchOperation: Array<JsonPatchOperation> = ; // A list of schema attribute update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard. The following properties are allowed for update \&#39;:\&#39; \&#39;label\&#39;, \&#39;helpText\&#39;, \&#39;placeholder\&#39;, \&#39;required\&#39;.
    this.api.patchNonEmployeeSchemaAttributeV1({ attributeId: attributeId, sourceId: sourceId, jsonPatchOperation: jsonPatchOperation }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `PatchNonEmployeeSourceV1RequestParams`.
...
export class ExampleComponent {
  ...
  patchNonEmployeeSourceV1(): void {
    const sourceId: string = ; // Source Id
    const jsonPatchOperation: Array<JsonPatchOperation> = ; // A list of non-employee source update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.
    this.api.patchNonEmployeeSourceV1({ sourceId: sourceId, jsonPatchOperation: jsonPatchOperation }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `RejectNonEmployeeRequestV1RequestParams`.
...
export class ExampleComponent {
  ...
  rejectNonEmployeeRequestV1(): void {
    const id: string = ; // Non-Employee approval item id (UUID)
    const nonEmployeeRejectApprovalDecision: NonEmployeeRejectApprovalDecision = ; // 
    this.api.rejectNonEmployeeRequestV1({ id: id, nonEmployeeRejectApprovalDecision: nonEmployeeRejectApprovalDecision }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
...
The service takes one object that holds every parameter. Its type is `UpdateNonEmployeeRecordV1RequestParams`.
...
export class ExampleComponent {
  ...
  updateNonEmployeeRecordV1(): void {
    const id: string = ; // Non-employee record id (UUID)
    ...
    this.api.updateNonEmployeeRecordV1({ id: id, nonEmployeeRequestBody: nonEmployeeRequestBody }).subscribe({
      next: (result) => console.log(result),
      error: (error) => console.error(error),
    });
  }
