---
id: access_model_metadata-model-query
title: Query
pagination_label: Query
sidebar_label: Query
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'Query', 'access_model_metadata']
slug: /tools/sdk/angular/access_model_metadata/models/query
tags: ['SDK', 'Software Development Kit', 'Query', 'access_model_metadata']
---
...
```typescript
import { Query } from 'sailpoint-angular-sdk/access_model_metadata';
```
