---
id: access_model_metadata-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'access_model_metadata']
slug: /tools/sdk/angular/access_model_metadata/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'access_model_metadata']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/access_model_metadata';
```
