---
id: connector_customizers-model-connector-customizer-create-response
...
keywords: ['angular', 'Angular', 'sdk', 'ConnectorCustomizerCreateResponse', 'connector_customizers']
slug: /tools/sdk/angular/connector_customizers/models/connector-customizer-create-response
tags: ['SDK', 'Software Development Kit', 'ConnectorCustomizerCreateResponse', 'connector_customizers']
---
...
```typescript
import { ConnectorCustomizerCreateResponse } from '@sailpoint/angular-sdk/connector_customizers';
```
