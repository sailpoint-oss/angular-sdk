---
id: connector_customizers-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'connector_customizers']
slug: /tools/sdk/angular/connector_customizers/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'connector_customizers']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/connector_customizers';
```
