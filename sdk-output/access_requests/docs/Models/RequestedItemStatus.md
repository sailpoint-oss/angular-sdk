---
id: access_requests-model-requested-item-status
title: RequestedItemStatus
pagination_label: RequestedItemStatus
sidebar_label: RequestedItemStatus
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'RequestedItemStatus', 'access_requests']
slug: /tools/sdk/angular/access_requests/models/requested-item-status
tags: ['SDK', 'Software Development Kit', 'RequestedItemStatus', 'access_requests']
---
...
```typescript
import { RequestedItemStatus } from '@sailpoint/angular-sdk/access_requests';
```
