---
id: access_requests-model-entitlement-access-request-config
...
keywords: ['angular', 'Angular', 'sdk', 'EntitlementAccessRequestConfig', 'access_requests']
slug: /tools/sdk/angular/access_requests/models/entitlement-access-request-config
tags: ['SDK', 'Software Development Kit', 'EntitlementAccessRequestConfig', 'access_requests']
---
...
```typescript
import { EntitlementAccessRequestConfig } from '@sailpoint/angular-sdk/access_requests';
```
