---
id: access_requests-model-access-request-item-form
title: AccessRequestItemForm
pagination_label: AccessRequestItemForm
sidebar_label: AccessRequestItemForm
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccessRequestItemForm', 'access_requests']
slug: /tools/sdk/angular/access_requests/models/access-request-item-form
tags: ['SDK', 'Software Development Kit', 'AccessRequestItemForm', 'access_requests']
---
...
```typescript
import { AccessRequestItemForm } from 'sailpoint-angular-sdk/access_requests';
```
