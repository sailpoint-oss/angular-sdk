---
id: access_requests-model-identity-reference-with-name-and-email
...
keywords: ['angular', 'Angular', 'sdk', 'IdentityReferenceWithNameAndEmail', 'access_requests']
slug: /tools/sdk/angular/access_requests/models/identity-reference-with-name-and-email
tags: ['SDK', 'Software Development Kit', 'IdentityReferenceWithNameAndEmail', 'access_requests']
---
...
```typescript
import { IdentityReferenceWithNameAndEmail } from '@sailpoint/angular-sdk/access_requests';
```
