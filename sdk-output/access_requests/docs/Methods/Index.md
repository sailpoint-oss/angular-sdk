---
id: access_requests-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: access_requests-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'access_requests', 'methods']
slug: /tools/sdk/angular/access_requests/methods
tags: ['SDK', 'Software Development Kit', 'access_requests', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **access_requests** endpoints:
