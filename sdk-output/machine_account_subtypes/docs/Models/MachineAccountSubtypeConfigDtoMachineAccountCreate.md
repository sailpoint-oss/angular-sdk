---
id: machine_account_subtypes-model-machine-account-subtype-config-dto-machine-account-create
...
keywords: ['angular', 'Angular', 'sdk', 'MachineAccountSubtypeConfigDtoMachineAccountCreate', 'machine_account_subtypes']
slug: /tools/sdk/angular/machine_account_subtypes/models/machine-account-subtype-config-dto-machine-account-create
tags: ['SDK', 'Software Development Kit', 'MachineAccountSubtypeConfigDtoMachineAccountCreate', 'machine_account_subtypes']
---
...
```typescript
import { MachineAccountSubtypeConfigDtoMachineAccountCreate } from '@sailpoint/angular-sdk/machine_account_subtypes';
```
