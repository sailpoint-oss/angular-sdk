---
id: notifications-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'notifications']
slug: /tools/sdk/angular/notifications/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'notifications']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/notifications';
```
