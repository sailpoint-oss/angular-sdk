---
id: notifications-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'notifications']
slug: /tools/sdk/angular/notifications/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'notifications']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/notifications';
```
