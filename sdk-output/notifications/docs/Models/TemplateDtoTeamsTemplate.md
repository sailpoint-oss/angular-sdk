---
id: notifications-model-template-dto-teams-template
title: TemplateDtoTeamsTemplate
pagination_label: TemplateDtoTeamsTemplate
sidebar_label: TemplateDtoTeamsTemplate
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TemplateDtoTeamsTemplate', 'notifications']
slug: /tools/sdk/angular/notifications/models/template-dto-teams-template
tags: ['SDK', 'Software Development Kit', 'TemplateDtoTeamsTemplate', 'notifications']
---
...
```typescript
import { TemplateDtoTeamsTemplate } from '@sailpoint/angular-sdk/notifications';
```
