---
id: privilege_criteria-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'privilege_criteria']
slug: /tools/sdk/angular/privilege_criteria/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'privilege_criteria']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/privilege_criteria';
```
