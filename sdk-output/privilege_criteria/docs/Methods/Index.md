---
id: privilege_criteria-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: privilege_criteria-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'privilege_criteria', 'methods']
slug: /tools/sdk/angular/privilege_criteria/methods
tags: ['SDK', 'Software Development Kit', 'privilege_criteria', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **privilege_criteria** endpoints:
