---
id: password_policies-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'password_policies']
slug: /tools/sdk/angular/password_policies/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'password_policies']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/password_policies';
```
