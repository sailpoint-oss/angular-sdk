---
id: sources-model-transform-read
title: TransformRead
pagination_label: TransformRead
sidebar_label: TransformRead
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TransformRead', 'sources']
slug: /tools/sdk/angular/sources/models/transform-read
tags: ['SDK', 'Software Development Kit', 'TransformRead', 'sources']
---
...
```typescript
import { TransformRead } from '@sailpoint/angular-sdk/sources';
```
