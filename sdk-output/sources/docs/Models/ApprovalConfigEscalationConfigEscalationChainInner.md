---
id: sources-model-approval-config-escalation-config-escalation-chain-inner
...
keywords: ['angular', 'Angular', 'sdk', 'ApprovalConfigEscalationConfigEscalationChainInner', 'sources']
slug: /tools/sdk/angular/sources/models/approval-config-escalation-config-escalation-chain-inner
tags: ['SDK', 'Software Development Kit', 'ApprovalConfigEscalationConfigEscalationChainInner', 'sources']
---
...
```typescript
import { ApprovalConfigEscalationConfigEscalationChainInner } from '@sailpoint/angular-sdk/sources';
```
