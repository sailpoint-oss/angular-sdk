---
id: sources-model-source-account-correlation-rule
...
keywords: ['angular', 'Angular', 'sdk', 'SourceAccountCorrelationRule', 'sources']
slug: /tools/sdk/angular/sources/models/source-account-correlation-rule
tags: ['SDK', 'Software Development Kit', 'SourceAccountCorrelationRule', 'sources']
---
...
```typescript
import { SourceAccountCorrelationRule } from 'sailpoint-angular-sdk/sources';
```
