---
id: sources-model-load-uncorrelated-accounts-task-task
...
keywords: ['angular', 'Angular', 'sdk', 'LoadUncorrelatedAccountsTaskTask', 'sources']
slug: /tools/sdk/angular/sources/models/load-uncorrelated-accounts-task-task
tags: ['SDK', 'Software Development Kit', 'LoadUncorrelatedAccountsTaskTask', 'sources']
---
...
```typescript
import { LoadUncorrelatedAccountsTaskTask } from '@sailpoint/angular-sdk/sources';
```
