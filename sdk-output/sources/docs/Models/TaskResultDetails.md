---
id: sources-model-task-result-details
title: TaskResultDetails
pagination_label: TaskResultDetails
sidebar_label: TaskResultDetails
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TaskResultDetails', 'sources']
slug: /tools/sdk/angular/sources/models/task-result-details
tags: ['SDK', 'Software Development Kit', 'TaskResultDetails', 'sources']
---
...
```typescript
import { TaskResultDetails } from 'sailpoint-angular-sdk/sources';
```
