---
id: sources-model-approval-config-serial-chain-inner
...
keywords: ['angular', 'Angular', 'sdk', 'ApprovalConfigSerialChainInner', 'sources']
slug: /tools/sdk/angular/sources/models/approval-config-serial-chain-inner
tags: ['SDK', 'Software Development Kit', 'ApprovalConfigSerialChainInner', 'sources']
---
...
```typescript
import { ApprovalConfigSerialChainInner } from 'sailpoint-angular-sdk/sources';
```
