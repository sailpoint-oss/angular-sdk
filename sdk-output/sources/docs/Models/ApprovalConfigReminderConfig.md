---
id: sources-model-approval-config-reminder-config
...
keywords: ['angular', 'Angular', 'sdk', 'ApprovalConfigReminderConfig', 'sources']
slug: /tools/sdk/angular/sources/models/approval-config-reminder-config
tags: ['SDK', 'Software Development Kit', 'ApprovalConfigReminderConfig', 'sources']
---
...
```typescript
import { ApprovalConfigReminderConfig } from '@sailpoint/angular-sdk/sources';
```
