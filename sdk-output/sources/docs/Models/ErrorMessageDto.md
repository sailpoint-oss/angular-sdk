---
id: sources-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'sources']
slug: /tools/sdk/angular/sources/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'sources']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/sources';
```
