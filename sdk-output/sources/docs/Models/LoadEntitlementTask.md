---
id: sources-model-load-entitlement-task
title: LoadEntitlementTask
pagination_label: LoadEntitlementTask
sidebar_label: LoadEntitlementTask
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'LoadEntitlementTask', 'sources']
slug: /tools/sdk/angular/sources/models/load-entitlement-task
tags: ['SDK', 'Software Development Kit', 'LoadEntitlementTask', 'sources']
---
...
```typescript
import { LoadEntitlementTask } from 'sailpoint-angular-sdk/sources';
```
