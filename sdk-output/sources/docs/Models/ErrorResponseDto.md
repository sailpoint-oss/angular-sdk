---
id: sources-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'sources']
slug: /tools/sdk/angular/sources/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'sources']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/sources';
```
