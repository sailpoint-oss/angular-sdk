---
id: sources-model-base-reference-dto
title: BaseReferenceDto
pagination_label: BaseReferenceDto
sidebar_label: BaseReferenceDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'BaseReferenceDto', 'sources']
slug: /tools/sdk/angular/sources/models/base-reference-dto
tags: ['SDK', 'Software Development Kit', 'BaseReferenceDto', 'sources']
---
...
```typescript
import { BaseReferenceDto } from 'sailpoint-angular-sdk/sources';
```
