---
id: sources-model-entitlement-access-request-config
...
keywords: ['angular', 'Angular', 'sdk', 'EntitlementAccessRequestConfig', 'sources']
slug: /tools/sdk/angular/sources/models/entitlement-access-request-config
tags: ['SDK', 'Software Development Kit', 'EntitlementAccessRequestConfig', 'sources']
---
...
```typescript
import { EntitlementAccessRequestConfig } from 'sailpoint-angular-sdk/sources';
```
