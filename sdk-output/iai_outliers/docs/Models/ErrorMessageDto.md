---
id: iai_outliers-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'iai_outliers']
slug: /tools/sdk/angular/iai_outliers/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'iai_outliers']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/iai_outliers';
```
