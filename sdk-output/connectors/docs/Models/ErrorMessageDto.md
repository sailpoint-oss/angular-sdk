---
id: connectors-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'connectors']
slug: /tools/sdk/angular/connectors/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'connectors']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/connectors';
```
