---
id: identity_attributes-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: identity_attributes-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'identity_attributes', 'methods']
slug: /tools/sdk/angular/identity_attributes/methods
tags: ['SDK', 'Software Development Kit', 'identity_attributes', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **identity_attributes** endpoints:
