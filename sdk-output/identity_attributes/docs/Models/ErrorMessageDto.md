---
id: identity_attributes-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'identity_attributes']
slug: /tools/sdk/angular/identity_attributes/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'identity_attributes']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/identity_attributes';
```
