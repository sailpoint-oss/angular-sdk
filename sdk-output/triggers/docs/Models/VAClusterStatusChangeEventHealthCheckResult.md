---
id: triggers-model-va-cluster-status-change-event-health-check-result
...
keywords: ['angular', 'Angular', 'sdk', 'VAClusterStatusChangeEventHealthCheckResult', 'triggers']
slug: /tools/sdk/angular/triggers/models/va-cluster-status-change-event-health-check-result
tags: ['SDK', 'Software Development Kit', 'VAClusterStatusChangeEventHealthCheckResult', 'triggers']
---
...
```typescript
import { VAClusterStatusChangeEventHealthCheckResult } from 'sailpoint-angular-sdk/triggers';
```
