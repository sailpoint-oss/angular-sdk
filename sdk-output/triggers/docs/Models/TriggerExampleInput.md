---
id: triggers-model-trigger-example-input
title: TriggerExampleInput
pagination_label: TriggerExampleInput
sidebar_label: TriggerExampleInput
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TriggerExampleInput', 'triggers']
slug: /tools/sdk/angular/triggers/models/trigger-example-input
tags: ['SDK', 'Software Development Kit', 'TriggerExampleInput', 'triggers']
---
...
```typescript
import { TriggerExampleInput } from '@sailpoint/angular-sdk/triggers';
```
