---
id: triggers-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'triggers']
slug: /tools/sdk/angular/triggers/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'triggers']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/triggers';
```
