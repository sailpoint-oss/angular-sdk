---
id: triggers-model-provisioning-completed-account-requests-inner-source
...
keywords: ['angular', 'Angular', 'sdk', 'ProvisioningCompletedAccountRequestsInnerSource', 'triggers']
slug: /tools/sdk/angular/triggers/models/provisioning-completed-account-requests-inner-source
tags: ['SDK', 'Software Development Kit', 'ProvisioningCompletedAccountRequestsInnerSource', 'triggers']
---
...
```typescript
import { ProvisioningCompletedAccountRequestsInnerSource } from 'sailpoint-angular-sdk/triggers';
```
