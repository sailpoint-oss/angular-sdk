---
id: triggers-model-account-aggregation-completed-stats
...
keywords: ['angular', 'Angular', 'sdk', 'AccountAggregationCompletedStats', 'triggers']
slug: /tools/sdk/angular/triggers/models/account-aggregation-completed-stats
tags: ['SDK', 'Software Development Kit', 'AccountAggregationCompletedStats', 'triggers']
---
...
```typescript
import { AccountAggregationCompletedStats } from '@sailpoint/angular-sdk/triggers';
```
