---
id: triggers-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'triggers']
slug: /tools/sdk/angular/triggers/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'triggers']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/triggers';
```
