---
id: triggers-model-access-request-pre-approval2
title: AccessRequestPreApproval2
pagination_label: AccessRequestPreApproval2
sidebar_label: AccessRequestPreApproval2
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccessRequestPreApproval2', 'triggers']
slug: /tools/sdk/angular/triggers/models/access-request-pre-approval2
tags: ['SDK', 'Software Development Kit', 'AccessRequestPreApproval2', 'triggers']
---
...
```typescript
import { AccessRequestPreApproval2 } from 'sailpoint-angular-sdk/triggers';
```
