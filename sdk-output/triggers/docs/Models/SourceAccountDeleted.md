---
id: triggers-model-source-account-deleted
title: SourceAccountDeleted
pagination_label: SourceAccountDeleted
sidebar_label: SourceAccountDeleted
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'SourceAccountDeleted', 'triggers']
slug: /tools/sdk/angular/triggers/models/source-account-deleted
tags: ['SDK', 'Software Development Kit', 'SourceAccountDeleted', 'triggers']
---
...
```typescript
import { SourceAccountDeleted } from 'sailpoint-angular-sdk/triggers';
```
