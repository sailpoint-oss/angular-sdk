---
id: triggers-model-va-cluster-status-change-event-application
...
keywords: ['angular', 'Angular', 'sdk', 'VAClusterStatusChangeEventApplication', 'triggers']
slug: /tools/sdk/angular/triggers/models/va-cluster-status-change-event-application
tags: ['SDK', 'Software Development Kit', 'VAClusterStatusChangeEventApplication', 'triggers']
---
...
```typescript
import { VAClusterStatusChangeEventApplication } from 'sailpoint-angular-sdk/triggers';
```
