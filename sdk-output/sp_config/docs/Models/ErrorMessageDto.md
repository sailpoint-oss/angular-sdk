---
id: sp_config-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'sp_config']
slug: /tools/sdk/angular/sp_config/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'sp_config']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/sp_config';
```
