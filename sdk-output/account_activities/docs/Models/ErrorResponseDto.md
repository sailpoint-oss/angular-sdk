---
id: account_activities-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'account_activities']
slug: /tools/sdk/angular/account_activities/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'account_activities']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/account_activities';
```
