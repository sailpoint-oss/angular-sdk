---
id: account_activities-model-account-activity-item
title: AccountActivityItem
pagination_label: AccountActivityItem
sidebar_label: AccountActivityItem
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccountActivityItem', 'account_activities']
slug: /tools/sdk/angular/account_activities/models/account-activity-item
tags: ['SDK', 'Software Development Kit', 'AccountActivityItem', 'account_activities']
---
...
```typescript
import { AccountActivityItem } from '@sailpoint/angular-sdk/account_activities';
```
