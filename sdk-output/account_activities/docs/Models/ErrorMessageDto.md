---
id: account_activities-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'account_activities']
slug: /tools/sdk/angular/account_activities/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'account_activities']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/account_activities';
```
