---
id: reports_data_extraction-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'reports_data_extraction']
slug: /tools/sdk/angular/reports_data_extraction/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'reports_data_extraction']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/reports_data_extraction';
```
