---
id: dimensions-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'dimensions']
slug: /tools/sdk/angular/dimensions/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'dimensions']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/dimensions';
```
