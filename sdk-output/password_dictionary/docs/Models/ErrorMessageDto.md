---
id: password_dictionary-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'password_dictionary']
slug: /tools/sdk/angular/password_dictionary/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'password_dictionary']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/password_dictionary';
```
