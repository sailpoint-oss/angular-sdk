---
id: global_tenant_security_settings-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: global_tenant_security_settings-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'global_tenant_security_settings', 'methods']
slug: /tools/sdk/angular/global_tenant_security_settings/methods
tags: ['SDK', 'Software Development Kit', 'global_tenant_security_settings', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **global_tenant_security_settings** endpoints:
