---
id: accounts-model-account
title: Account
pagination_label: Account
sidebar_label: Account
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'Account', 'accounts']
slug: /tools/sdk/angular/accounts/models/account
tags: ['SDK', 'Software Development Kit', 'Account', 'accounts']
---
...
```typescript
import { Account } from 'sailpoint-angular-sdk/accounts';
```
