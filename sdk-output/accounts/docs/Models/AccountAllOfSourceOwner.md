---
id: accounts-model-account-all-of-source-owner
title: AccountAllOfSourceOwner
pagination_label: AccountAllOfSourceOwner
sidebar_label: AccountAllOfSourceOwner
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccountAllOfSourceOwner', 'accounts']
slug: /tools/sdk/angular/accounts/models/account-all-of-source-owner
tags: ['SDK', 'Software Development Kit', 'AccountAllOfSourceOwner', 'accounts']
---
...
```typescript
import { AccountAllOfSourceOwner } from 'sailpoint-angular-sdk/accounts';
```
