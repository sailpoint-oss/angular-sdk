---
id: accounts-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'accounts']
slug: /tools/sdk/angular/accounts/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'accounts']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/accounts';
```
