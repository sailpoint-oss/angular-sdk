---
id: password_sync_groups-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'password_sync_groups']
slug: /tools/sdk/angular/password_sync_groups/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'password_sync_groups']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/password_sync_groups';
```
