---
id: data_access_security-model-task-info
title: TaskInfo
pagination_label: TaskInfo
sidebar_label: TaskInfo
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TaskInfo', 'data_access_security']
slug: /tools/sdk/angular/data_access_security/models/task-info
tags: ['SDK', 'Software Development Kit', 'TaskInfo', 'data_access_security']
---
...
```typescript
import { TaskInfo } from 'sailpoint-angular-sdk/data_access_security';
```
