---
id: data_access_security-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'data_access_security']
slug: /tools/sdk/angular/data_access_security/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'data_access_security']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/data_access_security';
```
