---
id: account_deletion_requests-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: account_deletion_requests-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'account_deletion_requests', 'methods']
slug: /tools/sdk/angular/account_deletion_requests/methods
tags: ['SDK', 'Software Development Kit', 'account_deletion_requests', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **account_deletion_requests** endpoints:
