---
id: account_deletion_requests-model-account-action-request-dto
title: AccountActionRequestDto
pagination_label: AccountActionRequestDto
sidebar_label: AccountActionRequestDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccountActionRequestDto', 'account_deletion_requests']
slug: /tools/sdk/angular/account_deletion_requests/models/account-action-request-dto
tags: ['SDK', 'Software Development Kit', 'AccountActionRequestDto', 'account_deletion_requests']
---
...
```typescript
import { AccountActionRequestDto } from 'sailpoint-angular-sdk/account_deletion_requests';
```
