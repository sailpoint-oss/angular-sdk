---
id: account_deletion_requests-model-account-action-request-dto-account-details
...
keywords: ['angular', 'Angular', 'sdk', 'AccountActionRequestDtoAccountDetails', 'account_deletion_requests']
slug: /tools/sdk/angular/account_deletion_requests/models/account-action-request-dto-account-details
tags: ['SDK', 'Software Development Kit', 'AccountActionRequestDtoAccountDetails', 'account_deletion_requests']
---
...
```typescript
import { AccountActionRequestDtoAccountDetails } from '@sailpoint/angular-sdk/account_deletion_requests';
```
