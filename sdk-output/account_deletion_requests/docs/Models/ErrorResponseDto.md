---
id: account_deletion_requests-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'account_deletion_requests']
slug: /tools/sdk/angular/account_deletion_requests/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'account_deletion_requests']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/account_deletion_requests';
```
