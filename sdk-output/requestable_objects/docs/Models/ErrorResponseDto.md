---
id: requestable_objects-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'requestable_objects']
slug: /tools/sdk/angular/requestable_objects/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'requestable_objects']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/requestable_objects';
```
