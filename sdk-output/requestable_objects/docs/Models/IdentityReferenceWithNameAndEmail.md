---
id: requestable_objects-model-identity-reference-with-name-and-email
...
keywords: ['angular', 'Angular', 'sdk', 'IdentityReferenceWithNameAndEmail', 'requestable_objects']
slug: /tools/sdk/angular/requestable_objects/models/identity-reference-with-name-and-email
tags: ['SDK', 'Software Development Kit', 'IdentityReferenceWithNameAndEmail', 'requestable_objects']
---
...
```typescript
import { IdentityReferenceWithNameAndEmail } from '@sailpoint/angular-sdk/requestable_objects';
```
