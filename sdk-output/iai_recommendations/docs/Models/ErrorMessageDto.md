---
id: iai_recommendations-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'iai_recommendations']
slug: /tools/sdk/angular/iai_recommendations/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'iai_recommendations']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/iai_recommendations';
```
