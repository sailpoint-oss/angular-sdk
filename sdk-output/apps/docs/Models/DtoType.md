---
id: apps-model-dto-type
title: DtoType
pagination_label: DtoType
sidebar_label: DtoType
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'DtoType', 'apps']
slug: /tools/sdk/angular/apps/models/dto-type
tags: ['SDK', 'Software Development Kit', 'DtoType', 'apps']
---
...
```typescript
import { DtoType } from 'sailpoint-angular-sdk/apps';
```
