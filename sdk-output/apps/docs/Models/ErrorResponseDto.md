---
id: apps-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'apps']
slug: /tools/sdk/angular/apps/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'apps']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/apps';
```
