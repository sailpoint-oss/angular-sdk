---
id: password_management-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'password_management']
slug: /tools/sdk/angular/password_management/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'password_management']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/password_management';
```
