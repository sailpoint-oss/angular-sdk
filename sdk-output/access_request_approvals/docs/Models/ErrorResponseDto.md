---
id: access_request_approvals-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'access_request_approvals']
slug: /tools/sdk/angular/access_request_approvals/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'access_request_approvals']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/access_request_approvals';
```
