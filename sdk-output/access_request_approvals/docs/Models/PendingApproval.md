---
id: access_request_approvals-model-pending-approval
title: PendingApproval
pagination_label: PendingApproval
sidebar_label: PendingApproval
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'PendingApproval', 'access_request_approvals']
slug: /tools/sdk/angular/access_request_approvals/models/pending-approval
tags: ['SDK', 'Software Development Kit', 'PendingApproval', 'access_request_approvals']
---
...
```typescript
import { PendingApproval } from '@sailpoint/angular-sdk/access_request_approvals';
```
