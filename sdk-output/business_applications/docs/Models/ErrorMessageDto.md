---
id: business_applications-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'business_applications']
slug: /tools/sdk/angular/business_applications/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'business_applications']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/business_applications';
```
