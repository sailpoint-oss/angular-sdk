---
id: business_applications-model-base-reference-dto
title: BaseReferenceDto
pagination_label: BaseReferenceDto
sidebar_label: BaseReferenceDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'BaseReferenceDto', 'business_applications']
slug: /tools/sdk/angular/business_applications/models/base-reference-dto
tags: ['SDK', 'Software Development Kit', 'BaseReferenceDto', 'business_applications']
---
...
```typescript
import { BaseReferenceDto } from 'sailpoint-angular-sdk/business_applications';
```
