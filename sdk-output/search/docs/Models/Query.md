---
id: search-model-query
title: Query
pagination_label: Query
sidebar_label: Query
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'Query', 'search']
slug: /tools/sdk/angular/search/models/query
tags: ['SDK', 'Software Development Kit', 'Query', 'search']
---
...
```typescript
import { Query } from 'sailpoint-angular-sdk/search';
```
