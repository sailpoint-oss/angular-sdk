---
id: search-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'search']
slug: /tools/sdk/angular/search/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'search']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/search';
```
