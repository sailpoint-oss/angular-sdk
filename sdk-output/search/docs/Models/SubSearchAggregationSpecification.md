---
id: search-model-sub-search-aggregation-specification
...
keywords: ['angular', 'Angular', 'sdk', 'SubSearchAggregationSpecification', 'search']
slug: /tools/sdk/angular/search/models/sub-search-aggregation-specification
tags: ['SDK', 'Software Development Kit', 'SubSearchAggregationSpecification', 'search']
---
...
```typescript
import { SubSearchAggregationSpecification } from '@sailpoint/angular-sdk/search';
```
