---
id: search-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'search']
slug: /tools/sdk/angular/search/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'search']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/search';
```
