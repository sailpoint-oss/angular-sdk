---
id: password_configuration-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'password_configuration']
slug: /tools/sdk/angular/password_configuration/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'password_configuration']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/password_configuration';
```
