---
id: mfa_configuration-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'mfa_configuration']
slug: /tools/sdk/angular/mfa_configuration/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'mfa_configuration']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/mfa_configuration';
```
