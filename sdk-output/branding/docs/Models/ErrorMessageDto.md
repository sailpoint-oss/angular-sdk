---
id: branding-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'branding']
slug: /tools/sdk/angular/branding/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'branding']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/branding';
```
