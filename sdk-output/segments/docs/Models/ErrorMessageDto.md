---
id: segments-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'segments']
slug: /tools/sdk/angular/segments/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'segments']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/segments';
```
