---
id: identities-model-task-status-message
title: TaskStatusMessage
pagination_label: TaskStatusMessage
sidebar_label: TaskStatusMessage
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TaskStatusMessage', 'identities']
slug: /tools/sdk/angular/identities/models/task-status-message
tags: ['SDK', 'Software Development Kit', 'TaskStatusMessage', 'identities']
---
...
```typescript
import { TaskStatusMessage } from '@sailpoint/angular-sdk/identities';
```
