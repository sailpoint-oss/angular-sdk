---
id: identities-model-task-status
title: TaskStatus
pagination_label: TaskStatus
sidebar_label: TaskStatus
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TaskStatus', 'identities']
slug: /tools/sdk/angular/identities/models/task-status
tags: ['SDK', 'Software Development Kit', 'TaskStatus', 'identities']
---
...
```typescript
import { TaskStatus } from '@sailpoint/angular-sdk/identities';
```
