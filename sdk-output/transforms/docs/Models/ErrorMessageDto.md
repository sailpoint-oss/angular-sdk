---
id: transforms-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'transforms']
slug: /tools/sdk/angular/transforms/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'transforms']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/transforms';
```
