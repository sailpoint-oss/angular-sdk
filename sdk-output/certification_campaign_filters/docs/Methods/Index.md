---
id: certification_campaign_filters-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: certification_campaign_filters-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'certification_campaign_filters', 'methods']
slug: /tools/sdk/angular/certification_campaign_filters/methods
tags: ['SDK', 'Software Development Kit', 'certification_campaign_filters', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **certification_campaign_filters** endpoints:
