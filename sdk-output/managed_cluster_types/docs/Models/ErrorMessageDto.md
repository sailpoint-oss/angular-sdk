---
id: managed_cluster_types-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'managed_cluster_types']
slug: /tools/sdk/angular/managed_cluster_types/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'managed_cluster_types']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/managed_cluster_types';
```
