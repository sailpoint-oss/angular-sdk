---
id: sod_policies-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'sod_policies']
slug: /tools/sdk/angular/sod_policies/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'sod_policies']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/sod_policies';
```
