---
id: sod_policies-model-report-result-reference
title: ReportResultReference
pagination_label: ReportResultReference
sidebar_label: ReportResultReference
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ReportResultReference', 'sod_policies']
slug: /tools/sdk/angular/sod_policies/models/report-result-reference
tags: ['SDK', 'Software Development Kit', 'ReportResultReference', 'sod_policies']
---
...
```typescript
import { ReportResultReference } from '@sailpoint/angular-sdk/sod_policies';
```
