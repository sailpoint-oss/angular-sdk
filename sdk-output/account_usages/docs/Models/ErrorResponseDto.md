---
id: account_usages-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'account_usages']
slug: /tools/sdk/angular/account_usages/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'account_usages']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/account_usages';
```
