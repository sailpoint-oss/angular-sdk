---
id: account_usages-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'account_usages']
slug: /tools/sdk/angular/account_usages/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'account_usages']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/account_usages';
```
