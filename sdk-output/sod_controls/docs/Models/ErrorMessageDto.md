---
id: sod_controls-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'sod_controls']
slug: /tools/sdk/angular/sod_controls/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'sod_controls']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/sod_controls';
```
