---
id: iai_access_request_recommendations-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'iai_access_request_recommendations']
slug: /tools/sdk/angular/iai_access_request_recommendations/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'iai_access_request_recommendations']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/iai_access_request_recommendations';
```
