---
id: iai_access_request_recommendations-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: iai_access_request_recommendations-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'iai_access_request_recommendations', 'methods']
slug: /tools/sdk/angular/iai_access_request_recommendations/methods
tags: ['SDK', 'Software Development Kit', 'iai_access_request_recommendations', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **iai_access_request_recommendations** endpoints:
