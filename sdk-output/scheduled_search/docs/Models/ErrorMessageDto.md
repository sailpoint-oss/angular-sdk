---
id: scheduled_search-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'scheduled_search']
slug: /tools/sdk/angular/scheduled_search/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'scheduled_search']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/scheduled_search';
```
