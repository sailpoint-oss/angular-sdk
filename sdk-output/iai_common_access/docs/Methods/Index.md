---
id: iai_common_access-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: iai_common_access-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'iai_common_access', 'methods']
slug: /tools/sdk/angular/iai_common_access/methods
tags: ['SDK', 'Software Development Kit', 'iai_common_access', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **iai_common_access** endpoints:
