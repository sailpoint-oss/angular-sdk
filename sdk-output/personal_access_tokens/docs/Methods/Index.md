---
id: personal_access_tokens-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: personal_access_tokens-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'personal_access_tokens', 'methods']
slug: /tools/sdk/angular/personal_access_tokens/methods
tags: ['SDK', 'Software Development Kit', 'personal_access_tokens', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **personal_access_tokens** endpoints:
