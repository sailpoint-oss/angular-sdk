---
id: personal_access_tokens-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'personal_access_tokens']
slug: /tools/sdk/angular/personal_access_tokens/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'personal_access_tokens']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/personal_access_tokens';
```
