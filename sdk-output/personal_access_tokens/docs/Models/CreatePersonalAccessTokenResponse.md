---
id: personal_access_tokens-model-create-personal-access-token-response
...
keywords: ['angular', 'Angular', 'sdk', 'CreatePersonalAccessTokenResponse', 'personal_access_tokens']
slug: /tools/sdk/angular/personal_access_tokens/models/create-personal-access-token-response
tags: ['SDK', 'Software Development Kit', 'CreatePersonalAccessTokenResponse', 'personal_access_tokens']
---
...
```typescript
import { CreatePersonalAccessTokenResponse } from '@sailpoint/angular-sdk/personal_access_tokens';
```
