---
id: shared_signals_framework_ssf-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'shared_signals_framework_ssf']
slug: /tools/sdk/angular/shared_signals_framework_ssf/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'shared_signals_framework_ssf']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/shared_signals_framework_ssf';
```
