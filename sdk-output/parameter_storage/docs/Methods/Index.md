---
id: parameter_storage-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: parameter_storage-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'parameter_storage', 'methods']
slug: /tools/sdk/angular/parameter_storage/methods
tags: ['SDK', 'Software Development Kit', 'parameter_storage', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **parameter_storage** endpoints:
