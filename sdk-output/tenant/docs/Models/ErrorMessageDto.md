---
id: tenant-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'tenant']
slug: /tools/sdk/angular/tenant/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'tenant']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/tenant';
```
