---
id: role_propagation-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'role_propagation']
slug: /tools/sdk/angular/role_propagation/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'role_propagation']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/role_propagation';
```
