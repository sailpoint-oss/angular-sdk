---
id: role_propagation-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'role_propagation']
slug: /tools/sdk/angular/role_propagation/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'role_propagation']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/role_propagation';
```
