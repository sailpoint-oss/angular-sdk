---
id: role_propagation-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: role_propagation-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'role_propagation', 'methods']
slug: /tools/sdk/angular/role_propagation/methods
tags: ['SDK', 'Software Development Kit', 'role_propagation', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **role_propagation** endpoints:
