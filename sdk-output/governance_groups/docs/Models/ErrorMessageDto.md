---
id: governance_groups-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'governance_groups']
slug: /tools/sdk/angular/governance_groups/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'governance_groups']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/governance_groups';
```
