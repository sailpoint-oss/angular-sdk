---
id: governance_groups-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: governance_groups-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'governance_groups', 'methods']
slug: /tools/sdk/angular/governance_groups/methods
tags: ['SDK', 'Software Development Kit', 'governance_groups', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **governance_groups** endpoints:
