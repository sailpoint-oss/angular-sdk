---
id: auth_users-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'auth_users']
slug: /tools/sdk/angular/auth_users/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'auth_users']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/auth_users';
```
