---
id: configuration_hub-model-draft-response
title: DraftResponse
pagination_label: DraftResponse
sidebar_label: DraftResponse
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'DraftResponse', 'configuration_hub']
slug: /tools/sdk/angular/configuration_hub/models/draft-response
tags: ['SDK', 'Software Development Kit', 'DraftResponse', 'configuration_hub']
---
...
```typescript
import { DraftResponse } from 'sailpoint-angular-sdk/configuration_hub';
```
