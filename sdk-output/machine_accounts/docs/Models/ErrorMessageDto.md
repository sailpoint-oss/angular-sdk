---
id: machine_accounts-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'machine_accounts']
slug: /tools/sdk/angular/machine_accounts/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'machine_accounts']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/machine_accounts';
```
