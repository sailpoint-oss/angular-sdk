---
id: sim_integrations-model-service-desk-source
title: ServiceDeskSource
pagination_label: ServiceDeskSource
sidebar_label: ServiceDeskSource
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ServiceDeskSource', 'sim_integrations']
slug: /tools/sdk/angular/sim_integrations/models/service-desk-source
tags: ['SDK', 'Software Development Kit', 'ServiceDeskSource', 'sim_integrations']
---
...
```typescript
import { ServiceDeskSource } from '@sailpoint/angular-sdk/sim_integrations';
```
