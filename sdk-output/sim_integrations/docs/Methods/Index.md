---
id: sim_integrations-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: sim_integrations-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'sim_integrations', 'methods']
slug: /tools/sdk/angular/sim_integrations/methods
tags: ['SDK', 'Software Development Kit', 'sim_integrations', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **sim_integrations** endpoints:
