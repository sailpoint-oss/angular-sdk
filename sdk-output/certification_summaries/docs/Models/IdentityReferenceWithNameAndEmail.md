---
id: certification_summaries-model-identity-reference-with-name-and-email
...
keywords: ['angular', 'Angular', 'sdk', 'IdentityReferenceWithNameAndEmail', 'certification_summaries']
slug: /tools/sdk/angular/certification_summaries/models/identity-reference-with-name-and-email
tags: ['SDK', 'Software Development Kit', 'IdentityReferenceWithNameAndEmail', 'certification_summaries']
---
...
```typescript
import { IdentityReferenceWithNameAndEmail } from 'sailpoint-angular-sdk/certification_summaries';
```
