---
id: certification_summaries-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: certification_summaries-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'certification_summaries', 'methods']
slug: /tools/sdk/angular/certification_summaries/methods
tags: ['SDK', 'Software Development Kit', 'certification_summaries', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **certification_summaries** endpoints:
