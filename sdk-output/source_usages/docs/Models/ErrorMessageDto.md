---
id: source_usages-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'source_usages']
slug: /tools/sdk/angular/source_usages/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'source_usages']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/source_usages';
```
