---
id: source_usages-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'source_usages']
slug: /tools/sdk/angular/source_usages/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'source_usages']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/source_usages';
```
