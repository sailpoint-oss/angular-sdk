---
id: managed_clients-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: managed_clients-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'managed_clients', 'methods']
slug: /tools/sdk/angular/managed_clients/methods
tags: ['SDK', 'Software Development Kit', 'managed_clients', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **managed_clients** endpoints:
