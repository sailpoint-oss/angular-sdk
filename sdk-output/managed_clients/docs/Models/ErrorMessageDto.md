---
id: managed_clients-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'managed_clients']
slug: /tools/sdk/angular/managed_clients/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'managed_clients']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/managed_clients';
```
