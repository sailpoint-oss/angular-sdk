---
id: identity_history-model-list-identity-access-items-v1200-response-inner
...
keywords: ['angular', 'Angular', 'sdk', 'ListIdentityAccessItemsV1200ResponseInner', 'identity_history']
slug: /tools/sdk/angular/identity_history/models/list-identity-access-items-v1200-response-inner
tags: ['SDK', 'Software Development Kit', 'ListIdentityAccessItemsV1200ResponseInner', 'identity_history']
---
...
```typescript
import { ListIdentityAccessItemsV1200ResponseInner } from 'sailpoint-angular-sdk/identity_history';
```
