---
id: identity_history-model-account-status-changed
title: AccountStatusChanged
pagination_label: AccountStatusChanged
sidebar_label: AccountStatusChanged
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AccountStatusChanged', 'identity_history']
slug: /tools/sdk/angular/identity_history/models/account-status-changed
tags: ['SDK', 'Software Development Kit', 'AccountStatusChanged', 'identity_history']
---
...
```typescript
import { AccountStatusChanged } from 'sailpoint-angular-sdk/identity_history';
```
