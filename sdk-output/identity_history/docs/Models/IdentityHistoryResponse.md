---
id: identity_history-model-identity-history-response
title: IdentityHistoryResponse
pagination_label: IdentityHistoryResponse
sidebar_label: IdentityHistoryResponse
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'IdentityHistoryResponse', 'identity_history']
slug: /tools/sdk/angular/identity_history/models/identity-history-response
tags: ['SDK', 'Software Development Kit', 'IdentityHistoryResponse', 'identity_history']
---
...
```typescript
import { IdentityHistoryResponse } from '@sailpoint/angular-sdk/identity_history';
```
