---
id: identity_history-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: identity_history-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'identity_history', 'methods']
slug: /tools/sdk/angular/identity_history/methods
tags: ['SDK', 'Software Development Kit', 'identity_history', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **identity_history** endpoints:
