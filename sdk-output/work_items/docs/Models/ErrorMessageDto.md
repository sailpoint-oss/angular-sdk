---
id: work_items-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'work_items']
slug: /tools/sdk/angular/work_items/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'work_items']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/work_items';
```
