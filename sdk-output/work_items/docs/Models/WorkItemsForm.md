---
id: work_items-model-work-items-form
title: WorkItemsForm
pagination_label: WorkItemsForm
sidebar_label: WorkItemsForm
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'WorkItemsForm', 'work_items']
slug: /tools/sdk/angular/work_items/models/work-items-form
tags: ['SDK', 'Software Development Kit', 'WorkItemsForm', 'work_items']
---
...
```typescript
import { WorkItemsForm } from '@sailpoint/angular-sdk/work_items';
```
