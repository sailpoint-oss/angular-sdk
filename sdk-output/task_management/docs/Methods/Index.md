---
id: task_management-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: task_management-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'task_management', 'methods']
slug: /tools/sdk/angular/task_management/methods
tags: ['SDK', 'Software Development Kit', 'task_management', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **task_management** endpoints:
