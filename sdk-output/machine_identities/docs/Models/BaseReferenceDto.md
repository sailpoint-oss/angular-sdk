---
id: machine_identities-model-base-reference-dto
title: BaseReferenceDto
pagination_label: BaseReferenceDto
sidebar_label: BaseReferenceDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'BaseReferenceDto', 'machine_identities']
slug: /tools/sdk/angular/machine_identities/models/base-reference-dto
tags: ['SDK', 'Software Development Kit', 'BaseReferenceDto', 'machine_identities']
---
...
```typescript
import { BaseReferenceDto } from '@sailpoint/angular-sdk/machine_identities';
```
