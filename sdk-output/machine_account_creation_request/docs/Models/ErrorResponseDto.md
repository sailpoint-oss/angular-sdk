---
id: machine_account_creation_request-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'machine_account_creation_request']
slug: /tools/sdk/angular/machine_account_creation_request/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'machine_account_creation_request']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/machine_account_creation_request';
```
