---
id: jit_access-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'jit_access']
slug: /tools/sdk/angular/jit_access/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'jit_access']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/jit_access';
```
