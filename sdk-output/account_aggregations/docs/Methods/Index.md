---
id: account_aggregations-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: account_aggregations-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'account_aggregations', 'methods']
slug: /tools/sdk/angular/account_aggregations/methods
tags: ['SDK', 'Software Development Kit', 'account_aggregations', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **account_aggregations** endpoints:
