---
id: account_aggregations-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'account_aggregations']
slug: /tools/sdk/angular/account_aggregations/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'account_aggregations']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/account_aggregations';
```
