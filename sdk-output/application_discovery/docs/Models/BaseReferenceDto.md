---
id: application_discovery-model-base-reference-dto
title: BaseReferenceDto
pagination_label: BaseReferenceDto
sidebar_label: BaseReferenceDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'BaseReferenceDto', 'application_discovery']
slug: /tools/sdk/angular/application_discovery/models/base-reference-dto
tags: ['SDK', 'Software Development Kit', 'BaseReferenceDto', 'application_discovery']
---
...
```typescript
import { BaseReferenceDto } from '@sailpoint/angular-sdk/application_discovery';
```
