---
id: application_discovery-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'application_discovery']
slug: /tools/sdk/angular/application_discovery/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'application_discovery']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/application_discovery';
```
