---
id: classify_source-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: classify_source-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'classify_source', 'methods']
slug: /tools/sdk/angular/classify_source/methods
tags: ['SDK', 'Software Development Kit', 'classify_source', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **classify_source** endpoints:
