---
id: declassify_source-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'declassify_source']
slug: /tools/sdk/angular/declassify_source/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'declassify_source']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/declassify_source';
```
