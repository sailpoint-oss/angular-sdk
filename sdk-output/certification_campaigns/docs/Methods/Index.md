---
id: certification_campaigns-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: certification_campaigns-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'certification_campaigns', 'methods']
slug: /tools/sdk/angular/certification_campaigns/methods
tags: ['SDK', 'Software Development Kit', 'certification_campaigns', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **certification_campaigns** endpoints:
