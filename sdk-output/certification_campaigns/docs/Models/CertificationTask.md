---
id: certification_campaigns-model-certification-task
title: CertificationTask
pagination_label: CertificationTask
sidebar_label: CertificationTask
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'CertificationTask', 'certification_campaigns']
slug: /tools/sdk/angular/certification_campaigns/models/certification-task
tags: ['SDK', 'Software Development Kit', 'CertificationTask', 'certification_campaigns']
---
...
```typescript
import { CertificationTask } from '@sailpoint/angular-sdk/certification_campaigns';
```
