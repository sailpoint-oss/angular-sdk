---
id: certification_campaigns-model-report-result-reference
title: ReportResultReference
pagination_label: ReportResultReference
sidebar_label: ReportResultReference
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ReportResultReference', 'certification_campaigns']
slug: /tools/sdk/angular/certification_campaigns/models/report-result-reference
tags: ['SDK', 'Software Development Kit', 'ReportResultReference', 'certification_campaigns']
---
...
```typescript
import { ReportResultReference } from '@sailpoint/angular-sdk/certification_campaigns';
```
