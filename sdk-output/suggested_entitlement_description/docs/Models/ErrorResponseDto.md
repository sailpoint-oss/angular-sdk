---
id: suggested_entitlement_description-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'suggested_entitlement_description']
slug: /tools/sdk/angular/suggested_entitlement_description/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'suggested_entitlement_description']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/suggested_entitlement_description';
```
