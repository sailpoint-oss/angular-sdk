---
id: org_config-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'org_config']
slug: /tools/sdk/angular/org_config/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'org_config']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/org_config';
```
