---
id: lifecycle_states-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: lifecycle_states-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'lifecycle_states', 'methods']
slug: /tools/sdk/angular/lifecycle_states/methods
tags: ['SDK', 'Software Development Kit', 'lifecycle_states', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **lifecycle_states** endpoints:
