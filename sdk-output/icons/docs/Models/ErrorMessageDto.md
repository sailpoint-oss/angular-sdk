---
id: icons-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'icons']
slug: /tools/sdk/angular/icons/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'icons']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/icons';
```
