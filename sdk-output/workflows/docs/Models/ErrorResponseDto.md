---
id: workflows-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'workflows']
slug: /tools/sdk/angular/workflows/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'workflows']
---
...
```typescript
import { ErrorResponseDto } from 'sailpoint-angular-sdk/workflows';
```
