---
id: workflows-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'workflows']
slug: /tools/sdk/angular/workflows/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'workflows']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/workflows';
```
