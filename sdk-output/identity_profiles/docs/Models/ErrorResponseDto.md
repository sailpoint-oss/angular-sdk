---
id: identity_profiles-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'identity_profiles']
slug: /tools/sdk/angular/identity_profiles/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'identity_profiles']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/identity_profiles';
```
