---
id: public_identities_config-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_position: 4
sidebar_key: public_identities_config-angular-models
sidebar_class_name: models
keywords: ['angular', 'Angular', 'sdk', 'public_identities_config', 'models']
slug: /tools/sdk/angular/public_identities_config/models
tags: ['SDK', 'Software Development Kit', 'public_identities_config', 'models']
---
...
```typescript
import { DtoType } from '@sailpoint/angular-sdk/public_identities_config';
```
