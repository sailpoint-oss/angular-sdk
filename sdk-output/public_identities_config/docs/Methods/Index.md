---
id: public_identities_config-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: public_identities_config-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'public_identities_config', 'methods']
slug: /tools/sdk/angular/public_identities_config/methods
tags: ['SDK', 'Software Development Kit', 'public_identities_config', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **public_identities_config** endpoints:
