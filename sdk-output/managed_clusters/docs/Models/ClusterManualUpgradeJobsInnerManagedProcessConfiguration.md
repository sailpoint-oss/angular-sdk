---
id: managed_clusters-model-cluster-manual-upgrade-jobs-inner-managed-process-configuration
...
keywords: ['angular', 'Angular', 'sdk', 'ClusterManualUpgradeJobsInnerManagedProcessConfiguration', 'managed_clusters']
slug: /tools/sdk/angular/managed_clusters/models/cluster-manual-upgrade-jobs-inner-managed-process-configuration
tags: ['SDK', 'Software Development Kit', 'ClusterManualUpgradeJobsInnerManagedProcessConfiguration', 'managed_clusters']
---
...
```typescript
import { ClusterManualUpgradeJobsInnerManagedProcessConfiguration } from 'sailpoint-angular-sdk/managed_clusters';
```
