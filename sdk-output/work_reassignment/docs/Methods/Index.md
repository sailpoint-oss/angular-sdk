---
id: work_reassignment-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: work_reassignment-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'work_reassignment', 'methods']
slug: /tools/sdk/angular/work_reassignment/methods
tags: ['SDK', 'Software Development Kit', 'work_reassignment', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **work_reassignment** endpoints:
