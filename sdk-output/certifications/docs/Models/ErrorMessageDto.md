---
id: certifications-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'certifications']
slug: /tools/sdk/angular/certifications/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'certifications']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/certifications';
```
