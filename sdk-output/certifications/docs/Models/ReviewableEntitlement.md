---
id: certifications-model-reviewable-entitlement
title: ReviewableEntitlement
pagination_label: ReviewableEntitlement
sidebar_label: ReviewableEntitlement
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ReviewableEntitlement', 'certifications']
slug: /tools/sdk/angular/certifications/models/reviewable-entitlement
tags: ['SDK', 'Software Development Kit', 'ReviewableEntitlement', 'certifications']
---
...
```typescript
import { ReviewableEntitlement } from '@sailpoint/angular-sdk/certifications';
```
