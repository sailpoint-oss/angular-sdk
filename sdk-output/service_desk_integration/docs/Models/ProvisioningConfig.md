---
id: service_desk_integration-model-provisioning-config
title: ProvisioningConfig
pagination_label: ProvisioningConfig
sidebar_label: ProvisioningConfig
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ProvisioningConfig', 'service_desk_integration']
slug: /tools/sdk/angular/service_desk_integration/models/provisioning-config
tags: ['SDK', 'Software Development Kit', 'ProvisioningConfig', 'service_desk_integration']
---
...
```typescript
import { ProvisioningConfig } from '@sailpoint/angular-sdk/service_desk_integration';
```
