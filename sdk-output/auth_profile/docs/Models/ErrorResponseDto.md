---
id: auth_profile-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'auth_profile']
slug: /tools/sdk/angular/auth_profile/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'auth_profile']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/auth_profile';
```
