---
id: access_request_identity_metrics-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: access_request_identity_metrics-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'access_request_identity_metrics', 'methods']
slug: /tools/sdk/angular/access_request_identity_metrics/methods
tags: ['SDK', 'Software Development Kit', 'access_request_identity_metrics', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **access_request_identity_metrics** endpoints:
