---
id: iai_role_mining-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: iai_role_mining-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'iai_role_mining', 'methods']
slug: /tools/sdk/angular/iai_role_mining/methods
tags: ['SDK', 'Software Development Kit', 'iai_role_mining', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **iai_role_mining** endpoints:
