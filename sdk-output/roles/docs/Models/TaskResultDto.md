---
id: roles-model-task-result-dto
title: TaskResultDto
pagination_label: TaskResultDto
sidebar_label: TaskResultDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'TaskResultDto', 'roles']
slug: /tools/sdk/angular/roles/models/task-result-dto
tags: ['SDK', 'Software Development Kit', 'TaskResultDto', 'roles']
---
...
```typescript
import { TaskResultDto } from 'sailpoint-angular-sdk/roles';
```
