---
id: roles-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'roles']
slug: /tools/sdk/angular/roles/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'roles']
---
...
```typescript
import { ErrorMessageDto } from '@sailpoint/angular-sdk/roles';
```
