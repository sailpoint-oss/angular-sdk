---
id: roles-model-additional-owner-ref
title: AdditionalOwnerRef
pagination_label: AdditionalOwnerRef
sidebar_label: AdditionalOwnerRef
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'AdditionalOwnerRef', 'roles']
slug: /tools/sdk/angular/roles/models/additional-owner-ref
tags: ['SDK', 'Software Development Kit', 'AdditionalOwnerRef', 'roles']
---
...
```typescript
import { AdditionalOwnerRef } from '@sailpoint/angular-sdk/roles';
```
