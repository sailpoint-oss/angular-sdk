---
id: entitlement_connections-methods
title: Methods
pagination_label: Methods
sidebar_label: Methods
sidebar_position: 3
sidebar_key: entitlement_connections-angular-methods
sidebar_class_name: methods
keywords: ['angular', 'Angular', 'sdk', 'entitlement_connections', 'methods']
slug: /tools/sdk/angular/entitlement_connections/methods
tags: ['SDK', 'Software Development Kit', 'entitlement_connections', 'methods']
---
...
## Available Methods
This is a list of the core methods available in the Angular SDK for the **entitlement_connections** endpoints:
