---
id: entitlement_connections-model-error-response-dto
title: ErrorResponseDto
pagination_label: ErrorResponseDto
sidebar_label: ErrorResponseDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorResponseDto', 'entitlement_connections']
slug: /tools/sdk/angular/entitlement_connections/models/error-response-dto
tags: ['SDK', 'Software Development Kit', 'ErrorResponseDto', 'entitlement_connections']
---
...
```typescript
import { ErrorResponseDto } from '@sailpoint/angular-sdk/entitlement_connections';
```
