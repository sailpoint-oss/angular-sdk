---
id: entitlement_connections-models
title: Models
pagination_label: Models
sidebar_label: Models
sidebar_position: 4
sidebar_key: entitlement_connections-angular-models
sidebar_class_name: models
keywords: ['angular', 'Angular', 'sdk', 'entitlement_connections', 'models']
slug: /tools/sdk/angular/entitlement_connections/models
tags: ['SDK', 'Software Development Kit', 'entitlement_connections', 'models']
---
...
```typescript
import { ArrayInner } from '@sailpoint/angular-sdk/entitlement_connections';
```
