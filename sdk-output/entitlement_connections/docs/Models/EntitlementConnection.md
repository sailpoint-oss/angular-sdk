---
id: entitlement_connections-model-entitlement-connection
title: EntitlementConnection
pagination_label: EntitlementConnection
sidebar_label: EntitlementConnection
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'EntitlementConnection', 'entitlement_connections']
slug: /tools/sdk/angular/entitlement_connections/models/entitlement-connection
tags: ['SDK', 'Software Development Kit', 'EntitlementConnection', 'entitlement_connections']
---
...
```typescript
import { EntitlementConnection } from 'sailpoint-angular-sdk/entitlement_connections';
```
