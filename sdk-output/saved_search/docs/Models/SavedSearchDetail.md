---
id: saved_search-model-saved-search-detail
title: SavedSearchDetail
pagination_label: SavedSearchDetail
sidebar_label: SavedSearchDetail
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'SavedSearchDetail', 'saved_search']
slug: /tools/sdk/angular/saved_search/models/saved-search-detail
tags: ['SDK', 'Software Development Kit', 'SavedSearchDetail', 'saved_search']
---
...
```typescript
import { SavedSearchDetail } from '@sailpoint/angular-sdk/saved_search';
```
