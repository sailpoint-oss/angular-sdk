---
id: saved_search-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'saved_search']
slug: /tools/sdk/angular/saved_search/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'saved_search']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/saved_search';
```
