---
id: sod_violations-model-policyviolationresponse
title: Policyviolationresponse
pagination_label: Policyviolationresponse
sidebar_label: Policyviolationresponse
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'Policyviolationresponse', 'sod_violations']
slug: /tools/sdk/angular/sod_violations/models/policyviolationresponse
tags: ['SDK', 'Software Development Kit', 'Policyviolationresponse', 'sod_violations']
---
...
```typescript
import { Policyviolationresponse } from '@sailpoint/angular-sdk/sod_violations';
```
