---
id: sod_violations-model-error-message-dto
title: ErrorMessageDto
pagination_label: ErrorMessageDto
sidebar_label: ErrorMessageDto
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'ErrorMessageDto', 'sod_violations']
slug: /tools/sdk/angular/sod_violations/models/error-message-dto
tags: ['SDK', 'Software Development Kit', 'ErrorMessageDto', 'sod_violations']
---
...
```typescript
import { ErrorMessageDto } from 'sailpoint-angular-sdk/sod_violations';
```
