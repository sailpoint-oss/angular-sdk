---
id: entitlements-model-load-entitlement-task
title: LoadEntitlementTask
pagination_label: LoadEntitlementTask
sidebar_label: LoadEntitlementTask
sidebar_class_name: angularsdk
keywords: ['angular', 'Angular', 'sdk', 'LoadEntitlementTask', 'entitlements']
slug: /tools/sdk/angular/entitlements/models/load-entitlement-task
tags: ['SDK', 'Software Development Kit', 'LoadEntitlementTask', 'entitlements']
---
...
```typescript
import { LoadEntitlementTask } from '@sailpoint/angular-sdk/entitlements';
```
